...
%         sFILTER     = CBASS_L2_GetFitlters(sREC, sTROUGH, sTRGH_RND, cSTATE{iBnd}, blZScore, iMth, inNClu); %Original 
        [sFILTER, sCLU, in1CluKM, in1Sel, in1CluSC] = CBASS_L2_GetFitlters(sREC, sTROUGH, sTRGH_RND, cSTATE{iBnd}, blZScore, iMth, inNClu);
...
%             chEmbedMethod, chDataFormat, blZScore, inN_Component, in1EmbedLabel);
        ...
        chLabelTag      = ['all_regions_'  cSTATE_LBL{1}];
        chFormatImg     = 'png';
        chRotate3D      = 'False';
        chAddLegend     = 'False';
        inFontSize      = '12';   
        ...
        chLabelTag      = ['enriched_'  cSTATE_LBL{1}];
        chFormatImg     = 'eps';
        chRotate3D      = 'False';
        chAddLegend     = 'True';
        inFontSize      = '12';   
        ...
        chLabelTag      = ['20Clusters' cSTATE_LBL{1}];
        chFormatImg     = 'png';
        chRotate3D      = 'False';
        chAddLegend     = 'False';
        inFontSize      = '12';
        ...
        chLabelTag      = ['SigClusters' cSTATE_LBL{1}];
        chFormatImg     = 'eps';
        chRotate3D      = 'False';
        chAddLegend     = 'True';
        inFontSize      = '12';
