function [sPART] = CBASS_L2_PartitionTrough(sTROUGH, bl1Epoch, ...
    bl1Baseline, blZScore, inNClu, dbSigThrs, inNIter)
...
if ~exist('inNIter', 'var'), inNIter = 1000; elseif isempty(inNIter), inNIter = 1000; end
...
dbThreshold     = CBASS_U_ScoreThreshold(sTROUGH.db2Trough, db1Score);
