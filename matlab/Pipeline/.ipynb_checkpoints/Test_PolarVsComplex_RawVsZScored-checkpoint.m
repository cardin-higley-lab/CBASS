...
chOutPath   = fullfile(chPath,'Matlab_Pipeline', 'Test_PolarVsComplex_RawVsZScored');
...
for iBnd = 1:length(cBAND)
    for iFmt = 1:length(cFORMAT)
        ...
        [status, commandOut] = CBASS_L2_PlotEmbed(sTROUGH, chTmpPath, chOutPath, chExpLabel, ...
